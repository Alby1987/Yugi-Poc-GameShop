...
namespace Yugi_Poc_GameShop.PoCTools.Decoder
{
    public class PoCDecoder: IPoCDecoder
    {
        ...
        {
            byte[] checksum = GenerateSpecialChecksum(inputBuffer, length);

            bool isValid =
                checksum[0] == inputBuffer[0] &&
                checksum[1] == inputBuffer[1] &&
                checksum[2] == inputBuffer[2] &&
                checksum[3] == inputBuffer[3];
